				...
				<div class="col-md-4">
					...
					<form action="/upload" method="post" enctype="multipart/form-data">
						<img src="/images/${ imageName }" alt="/images/user-solid.svg" />
						 <div>
						 <input type="file" style="border: 2px solid black; " class="file btn btn-lg btn-primary"name="file" value="Choose Photo" />
						 </div>
						 <div>
						 <input type="submit"style="border: 2px solid black; " class="file btn btn-lg btn-primary" value="Upload Image" name="Submit">
						</div>
						</form>
