...
public class TriangleAreaServiceLocator extends org.apache.axis.client.Service implements DefaultNamespace.TriangleAreaService {
    ...
    private java.lang.String TriangleArea_address = "http://localhost:8080/SOAPWebService/services/TriangleArea";
    ...
    public DefaultNamespace.TriangleArea getTriangleArea() throws javax.xml.rpc.ServiceException {
    ...
    public DefaultNamespace.TriangleArea getTriangleArea(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            DefaultNamespace.TriangleAreaSoapBindingStub _stub = new DefaultNamespace.TriangleAreaSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DefaultNamespace.TriangleArea.class.isAssignableFrom(serviceEndpointInterface)) {
                DefaultNamespace.TriangleAreaSoapBindingStub _stub = new DefaultNamespace.TriangleAreaSoapBindingStub(new java.net.URL(TriangleArea_address), this);
                _stub.setPortName(getTriangleAreaWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://DefaultNamespace", "TriangleAreaService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://DefaultNamespace", "TriangleArea"));
        }
